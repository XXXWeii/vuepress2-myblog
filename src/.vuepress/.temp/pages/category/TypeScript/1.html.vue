<template><div><p>当你学习 TypeScript 时，你的第一印象可能会欺骗你：这不就是 JavaScript 注解的一种方式吗？不就是编译器用来帮助我找到潜在 bug 的吗？</p>
<p>虽然这种说法没错，但随着你对 TypeScript 不断了解，你会发现这门编程语言最不可思议的力量在于编写、推断和操作数据类型。</p>
<p>本文总结的一些技巧，可以帮助大家充分发挥 TypeScript 的潜力。</p>
<h2 id="_1-用集合的概念思考问题" tabindex="-1"><a class="header-anchor" href="#_1-用集合的概念思考问题" aria-hidden="true">#</a> #1 用集合的概念思考问题</h2>
<hr>
<p>数据类型是程序员日常要处理的概念，但要简洁地定义它却出奇地困难。然而我发现集合非常适合用作概念模型。</p>
<p>刚开始学习 TypeScript 时，我们常常会发现用 TypeScript 编写类型的方式很不自然。举一个非常简单的例子：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">Measure</span> <span class="token operator">=</span> <span class="token punctuation">{</span> radius<span class="token operator">:</span> <span class="token builtin">number</span> <span class="token punctuation">}</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果你在逻辑 AND 的意义上解释运算符<code v-pre>&amp;</code>，可能会认为 Circle 是一个虚拟类型，因为它是两种类型的结合，没有任何重叠的字段。这不是 TypeScript 的工作方式。此时通过集合的概念思考更容易推断出正确的行为：</p>
<ul>
<li>每个类型都是一系列值的集合。</li>
<li>有些集合是无限的：例如<code v-pre>string</code>、<code v-pre>object</code>；有些是有限的：例如<code v-pre>bool</code>，<code v-pre>undefined</code>，...</li>
<li><code v-pre>unknown</code>是通用集（包括所有值），而<code v-pre>never</code>是空集（包括无值）。</li>
<li>类型<code v-pre>Measure</code>是包含<code v-pre>radius</code>数字字段的所有对象的集合。<code v-pre>style</code>也是如此。</li>
<li><code v-pre>&amp;</code>运算符创建一个交集：<code v-pre>Measure &amp; Style</code>表示包含<code v-pre>radius</code>和<code v-pre>color</code>的对象集，这实际上是一个较小的集合，字段更常用。</li>
<li>同理，<code v-pre>|</code>运算符创建一个并集：一个较大的集合，但常用字段可能较少（如果组合两个对象类型的话）。</li>
</ul>
<p>集合还有助于了解可分配性：仅当值的类型是目标类型的子集时，才允许赋值：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">ShapeKind</span> <span class="token operator">=</span> <span class="token string">"rect"</span> <span class="token operator">|</span> <span class="token string">"circle"</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-了解声明类型和收窄类型" tabindex="-1"><a class="header-anchor" href="#_2-了解声明类型和收窄类型" aria-hidden="true">#</a> #2 了解声明类型和收窄类型</h2>
<hr>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-使用可区分的联合类型而不是可选字段" tabindex="-1"><a class="header-anchor" href="#_3-使用可区分的联合类型而不是可选字段" aria-hidden="true">#</a> #3 使用可区分的联合类型而不是可选字段</h2>
<hr>
<p>当定义一组多态类型（如<code v-pre>Shape</code>）时，很容易这样开始写代码：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">Shape</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>需要非空断言（访问<code v-pre>radius</code>、<code v-pre>width</code>和<code v-pre>height</code>时），因为<code v-pre>kind</code>和其他字段之间没有建立关系。相反，可区分的联合类型是一个更好的解决方案：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">Circle</span> <span class="token operator">=</span> <span class="token punctuation">{</span> kind<span class="token operator">:</span> <span class="token string">"circle"</span><span class="token punctuation">;</span> radius<span class="token operator">:</span> <span class="token builtin">number</span> <span class="token punctuation">}</span><span class="token punctuation">;</span>
...
<h2 id="_4-使用类型谓词避免类型断言" tabindex="-1"><a class="header-anchor" href="#_4-使用类型谓词避免类型断言" aria-hidden="true">#</a> #4 使用类型谓词避免类型断言</h2>
<hr>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>更优雅的解决方案是将<code v-pre>isCircle</code>和<code v-pre>isRect</code>更改为返回类型谓词，这样就可以帮助 TypeScript 在<code v-pre>filter</code>调用后进一步收窄类型：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">isCircle</span><span class="token punctuation">(</span>shape<span class="token operator">:</span> Shape<span class="token punctuation">)</span><span class="token operator">:</span> shape <span class="token keyword">is</span> Circle <span class="token punctuation">{</span>
    <span class="token keyword">return</span> shape<span class="token punctuation">.</span>kind <span class="token operator">===</span> <span class="token string">'circle'</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-控制联合类型的分布方式" tabindex="-1"><a class="header-anchor" href="#_5-控制联合类型的分布方式" aria-hidden="true">#</a> #5 控制联合类型的分布方式</h2>
<hr>
<p>类型推断是 TypeScript 的特性；大多数时候，它默默地为你工作。但是有时你可能对模棱两可的细微情况进行干预。分布式条件类型就是其中一种情况。</p>
<p>假设我们有一个<code v-pre>ToArray</code>辅助类，如果输入类型还不是数组类型，则返回数组类型：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">ToArray<span class="token operator">&lt;</span><span class="token constant">T</span><span class="token operator">></span></span> <span class="token operator">=</span> <span class="token constant">T</span> <span class="token keyword">extends</span> <span class="token class-name"><span class="token builtin">Array</span><span class="token operator">&lt;</span><span class="token builtin">unknown</span><span class="token operator">></span></span> <span class="token operator">?</span> <span class="token constant">T</span> <span class="token operator">:</span> <span class="token constant">T</span><span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>你认为以下类型会推断出什么？</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">Foo</span> <span class="token operator">=</span> ToArray<span class="token operator">&lt;</span><span class="token builtin">string</span> <span class="token operator">|</span> <span class="token builtin">number</span><span class="token operator">></span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>答案是<code v-pre>string[] | number[]</code>。但这是模棱两可的。为什么不是<code v-pre>(string | number)[]</code>呢？</p>
<p>默认情况下，当 TypeScript 遇到联合类型（此处为<code v-pre>string | number</code>）的泛型参数（此处为<code v-pre>T</code>）时，它会分布到每个组成部分中，这就是为什么会得到<code v-pre>string[] | number[]</code>的原因。你可以通过使用特殊语法并将<code v-pre>T</code>包装在一对<code v-pre>[]</code>中来更改此行为，例如：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>现在<code v-pre>Foo</code>被推断为类型<code v-pre>(string | number)[]</code>。</p>
<h2 id="_6-使用详尽检查捕获在编译时未处理的情况" tabindex="-1"><a class="header-anchor" href="#_6-使用详尽检查捕获在编译时未处理的情况" aria-hidden="true">#</a> #6 使用详尽检查捕获在编译时未处理的情况</h2>
<hr>
<p>在<code v-pre>switch</code>语句中使用<code v-pre>enum</code>枚举时，一个好习惯是在没有匹配到合适值的情况下主动抛错，而不是像在其他编程语言中那样默默地忽略它们：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">getArea</span><span class="token punctuation">(</span>shape<span class="token operator">:</span> Shape<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过使用<code v-pre>never</code>类型，静态类型检查就可以更早地查找到错误：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">getArea</span><span class="token punctuation">(</span>shape<span class="token operator">:</span> Shape<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">switch</span> <span class="token punctuation">(</span>shape<span class="token punctuation">.</span>kind<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">case</span> <span class="token string">"circle"</span><span class="token operator">:</span>
      <span class="token keyword">return</span> Math<span class="token punctuation">.</span><span class="token constant">PI</span> <span class="token operator">*</span> shape<span class="token punctuation">.</span>radius <span class="token operator">**</span> <span class="token number">2</span><span class="token punctuation">;</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>有了这个，在添加新的<code v-pre>shape</code>种类时，就不可能忘记更新<code v-pre>getArea</code>函数。</p>
<p>该技术背后的基本原理是，除了<code v-pre>never</code>之外，不能为<code v-pre>never</code>类型分配任何内容。如果<code v-pre>shape.kind</code>的所有备选项都被<code v-pre>case</code>语句用尽，那么达到<code v-pre>default</code>的唯一可能类型是<code v-pre>never</code>；但是，如果未涵盖所有备选项，则将泄漏到<code v-pre>default</code>分支并导致无效分配。</p>
<h2 id="_7-宁可使用-type-而不是-interface" tabindex="-1"><a class="header-anchor" href="#_7-宁可使用-type-而不是-interface" aria-hidden="true">#</a> #7 宁可使用 type 而不是 interface</h2>
<hr>
<p>在 TypeScript 中，<code v-pre>type</code>和<code v-pre>interface</code>是两种非常相似的数据结构，都可以用来构造复杂的对象的。虽然可能有争议，但我的建议是在大多数情况下始终使用 type，仅在满足以下任一条件时才使用<code v-pre>interface</code>：</p>
<ul>
<li>想利用 interface 的合并功能。</li>
<li>有涉及类/接口层次结构的 OO 样式代码。</li>
</ul>
<p>否则，始终使用更通用的<code v-pre>type</code>构造会产生更一致的代码。</p>
<h2 id="_8-只要合适宁可使用元组而不是数组" tabindex="-1"><a class="header-anchor" href="#_8-只要合适宁可使用元组而不是数组" aria-hidden="true">#</a> #8 只要合适宁可使用元组而不是数组</h2>
<hr>
<p>对象类型是构造结构化数据的常用方法，但有时你可能希望使用更简洁的表示形式，而改用简单的数组。例如，<code v-pre>Circle</code>可以定义为：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>但是这种构造是松散的，如果创建类似<code v-pre>['circle', '1.0']</code>的内容很容易出错。我们可以通过使用元组来使其更严格：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用元组的一个很好的例子是 React 中的<code v-pre>useState</code>。</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">const</span> <span class="token punctuation">[</span>name<span class="token punctuation">,</span> setName<span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token function">useState</span><span class="token punctuation">(</span><span class="token string">""</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>既紧凑又类型安全。</p>
<h2 id="_9-控制推断类型的通用性或特殊性" tabindex="-1"><a class="header-anchor" href="#_9-控制推断类型的通用性或特殊性" aria-hidden="true">#</a> #9 控制推断类型的通用性或特殊性</h2>
<hr>
...
<li>使用<code v-pre>satisfies</code>来检查类型，而不影响推断的类型</li>
</ul>
<p>请看以下示例：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">NamedCircle</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>有个错误，这是因为根据<code v-pre>circle</code>的声明类型<code v-pre>NamedCircle，name</code>字段确实可以未定义，即使变量初始值设定项提供了字符串值。当然，我们可以删除<code v-pre>:NamedCircle</code>类型注释，但这将松散对<code v-pre>circle</code>对象有效性的类型检查。进退两难。</p>
<p>幸运的是，Typescript 4.9 引入了一个新的<code v-pre>satisfies</code>关键字，它允许你在不更改推断类型的情况下检查类型：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">NamedCircle</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
    radius<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
    name<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
...
<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>circle<span class="token punctuation">.</span>name<span class="token punctuation">.</span>length<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改后的版本具有两个优点：对象字面量保证符合<code v-pre>NamedCircle</code>类型，推断类型具有不可为空的名称字段。</p>
<h2 id="_10-使用-infer-创建额外的泛型类型参数" tabindex="-1"><a class="header-anchor" href="#_10-使用-infer-创建额外的泛型类型参数" aria-hidden="true">#</a> #10 使用 infer 创建额外的泛型类型参数</h2>
<hr>
<p>在设计实用工具函数和类型时，你经常会觉得需要使用从给定类型参数中提取的类型。在这种情况下，<code v-pre>infer</code>关键字就可以派上用场。它可以帮助快速推断新的类型参数。下面是两个简单的例子：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token comment">// gets the unwrapped type out of a Promise;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>infer</code>关键字在<code v-pre>T extends Promise&lt;infer U&gt;</code>中的工作原理可以理解为：假设<code v-pre>T</code>与一些实例化的泛型 Promise 类型兼容，临时凑合一个类型参数<code v-pre>U</code>以使其工作。因此，如果<code v-pre>T</code>被实例化为<code v-pre>Promise&lt;string&gt;</code>，则<code v-pre>U</code>的解决方案将是<code v-pre>string</code>。</p>
<h2 id="_11-创新类型操作以保持-dry" tabindex="-1"><a class="header-anchor" href="#_11-创新类型操作以保持-dry" aria-hidden="true">#</a> #11 创新类型操作以保持 DRY</h2>
<hr>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>还不如使用<code v-pre>pick</code>实用程序提取新类型：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">User</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  age<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span>
  gender<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
  country<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>与其复制函数的返回类型：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">createCircle</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>还不如使用<code v-pre>ReturnType&lt;T&gt;</code>提取：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">createCircle</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">return</span> <span class="token punctuation">{</span>
        kind<span class="token operator">:</span> <span class="token string">'circle'</span> <span class="token keyword">as</span> <span class="token keyword">const</span><span class="token punctuation">,</span>
        radius<span class="token operator">:</span> <span class="token number">1.0</span>
...
<span class="token function">transformCircle</span><span class="token punctuation">(</span><span class="token function">createCircle</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>与其并行同步两种类型的<code v-pre>shape</code>（此处为<code v-pre>config</code>类型和<code v-pre>Factory</code>）：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">ContentTypes</span> <span class="token operator">=</span> <span class="token string">'news'</span> <span class="token operator">|</span> <span class="token string">'blog'</span> <span class="token operator">|</span> <span class="token string">'video'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>还不如使用映射类型和模板字面量类型根据<code v-pre>config</code>的形状自动推断正确的<code v-pre>factory</code>类型：</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">ContentTypes</span> <span class="token operator">=</span> <span class="token string">'news'</span> <span class="token operator">|</span> <span class="token string">'blog'</span> <span class="token operator">|</span> <span class="token string">'video'</span><span class="token punctuation">;</span>
