<template><div><h2 id="一、什么是设计模式" tabindex="-1"><a class="header-anchor" href="#一、什么是设计模式" aria-hidden="true">#</a> 一、什么是设计模式？</h2>
<hr>
...
<h2 id="二、设计几个原则" tabindex="-1"><a class="header-anchor" href="#二、设计几个原则" aria-hidden="true">#</a> 二、设计几个原则</h2>
<hr>
<p>单一职责原则、开放封闭原则、里式替换原则、接口隔离原则 、依赖反转原则 、最少知识原则。</p>
<p>下面我们一起来看看几种在前端领域常见的设计模式：</p>
<p>单例模式、工厂模式、策略模式、代理模式、适配器模式、观察者模式/发布-订阅模式</p>
<h2 id="三、常见的设计模式及实际案例" tabindex="-1"><a class="header-anchor" href="#三、常见的设计模式及实际案例" aria-hidden="true">#</a> 三、常见的设计模式及实际案例</h2>
<hr>
<h3 id="单例模式" tabindex="-1"><a class="header-anchor" href="#单例模式" aria-hidden="true">#</a> 单例模式</h3>
<hr>
<h4 id="_1-什么是单例模式" tabindex="-1"><a class="header-anchor" href="#_1-什么是单例模式" aria-hidden="true">#</a> 1.什么是单例模式？</h4>
<p>单例模式 （Singleton Pattern）又称为单体模式，保证一个类只有一个实例，并提供一个访问它的全局访问点。也就是说，第二次使用同一个类创建新对象的时候，应该得到与第一次创建的对象完全相同的对象。</p>
<h4 id="vue-中的单例模式" tabindex="-1"><a class="header-anchor" href="#vue-中的单例模式" aria-hidden="true">#</a> Vue 中的单例模式</h4>
<p>（1）Element UI</p>
...
<p>指令形式注册的使用方式 ：</p>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">:v-loading.fullscreen</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>true<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>...<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>服务形式注册的使用方式 ：</p>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>this.$loading({ fullscreen: true });
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>用服务方式使用全屏 Loading 是单例的，即在前一个全屏 Loading 关闭前再次调用全屏 Loading，并不会创建一个新的 Loading 实例，而是返回现有全屏 Loading 的实例。</p>
<p>下面是 ElementUI 实现全屏 Loading 的源码：</p>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>import Vue from 'vue' import loadingVue from './loading.vue' const
...
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>// 安装vuex插件 Vue.use(Vuex) // 将store注入到Vue实例中 new Vue({ el: '#app',
store })
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>通过调用 Vue.use()方法，安装了 Vuex 插件。Vuex 插件是一个对象，它在内部实现了一个 install 方法，这个方法会在插件安装时被调用，从而把 Store 注入到 Vue 实例里去。也就是说每 install 一次，都会尝试给 Vue 实例注入一个 Store。</p>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code>let Vue // 这个Vue的作用和楼上的instance作用一样 ... export function install
(_Vue) { //
...
<hr>
<h4 id="_1-什么是工厂模式" tabindex="-1"><a class="header-anchor" href="#_1-什么是工厂模式" aria-hidden="true">#</a> 1.什么是工厂模式？</h4>
...
<h4 id="vue-中的工厂模式" tabindex="-1"><a class="header-anchor" href="#vue-中的工厂模式" aria-hidden="true">#</a> Vue 中的工厂模式</h4>
<p>（1）VNode</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>createElement('h3', { class: 'main-title' }, [
    createElement('img', { class: 'avatar', attrs: { src: '../avatar.jpg' } }),
    createElement('p', { class: 'user-desc' }, 'hello world')
])
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>createElement 函数结构大概如下：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>class Vnode (tag, data, children) { ... }
function createElement(tag, data, children) {
      return new Vnode(tag, data, children)
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>（2）vue-route</p>
<p>在 Vue 在路由创建模式中，也多次用到了工厂模式：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">class</span> <span class="token class-name">VueRouter</span> <span class="token punctuation">{</span>
...
<hr>
<h4 id="_1-什么是策略模式" tabindex="-1"><a class="header-anchor" href="#_1-什么是策略模式" aria-hidden="true">#</a> 1.什么是策略模式？</h4>
<p>策略模式 （Strategy Pattern）又称政策模式，其定义一系列的算法，把它们一个个封装起来，并且使它们可以互相替换。封装的策略算法一般是独立的，策略模式根据输入来调整采用哪个算法。关键是策略的实现和使用分离。</p>
<h4 id="策略模式的实际应用" tabindex="-1"><a class="header-anchor" href="#策略模式的实际应用" aria-hidden="true">#</a> 策略模式的实际应用</h4>
<p>（1）表格 formatter</p>
...
<p>首先实现文件计算的算法：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">const</span> StrategyMap <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<figure><img src="@source/category/Vue/images/202304151.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>（2）表单验证</p>
...
<p>实现通用的表单验证方法：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// src/utils/validates.js</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// src/utils/index.js</span>
...
<figure><img src="@source/category/Vue/images/202304152.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="代理模式" tabindex="-1"><a class="header-anchor" href="#代理模式" aria-hidden="true">#</a> 代理模式</h3>
<hr>
<h4 id="_1-什么是代理模式" tabindex="-1"><a class="header-anchor" href="#_1-什么是代理模式" aria-hidden="true">#</a> 1.什么是代理模式？</h4>
...
<h4 id="代理模式在实战中的应用" tabindex="-1"><a class="header-anchor" href="#代理模式在实战中的应用" aria-hidden="true">#</a> 代理模式在实战中的应用</h4>
<p>（1）拦截器</p>
...
<hr>
<h4 id="_1-什么是适配器模式" tabindex="-1"><a class="header-anchor" href="#_1-什么是适配器模式" aria-hidden="true">#</a> 1.什么是适配器模式？</h4>
...
<h4 id="适配器的实际案例" tabindex="-1"><a class="header-anchor" href="#适配器的实际案例" aria-hidden="true">#</a> 适配器的实际案例</h4>
<p>（1）Vue 计算属性</p>
...
<h3 id="观察者模式-发布-订阅模式" tabindex="-1"><a class="header-anchor" href="#观察者模式-发布-订阅模式" aria-hidden="true">#</a> 观察者模式/发布-订阅模式</h3>
<hr>
...
<figure><img src="@source/category/Vue/images/202304153.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h4 id="_1-创建事件中心管理组件之间的通信" tabindex="-1"><a class="header-anchor" href="#_1-创建事件中心管理组件之间的通信" aria-hidden="true">#</a> 1.创建事件中心管理组件之间的通信</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-发送事件" tabindex="-1"><a class="header-anchor" href="#_2-发送事件" aria-hidden="true">#</a> 2.发送事件</h4>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-接收事件" tabindex="-1"><a class="header-anchor" href="#_3-接收事件" aria-hidden="true">#</a> 3.接收事件</h4>
...
<figure><img src="@source/category/Vue/images/202304154.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<p>Vue 的源码：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// src/core/observer/index.js 响应式化过程</span>
