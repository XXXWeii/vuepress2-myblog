<template><div><p><code v-pre>history</code>模式会出现刷新页面后，页面出现 404。解决的办法是用<code v-pre>nginx</code>配置一下。
在<code v-pre>nginx</code>的配置文件中修改</p>
<h1 id="方法一" tabindex="-1"><a class="header-anchor" href="#方法一" aria-hidden="true">#</a> 方法一：</h1>
<hr>
...
<p>vue.js 官方教程里提到的<a href="https://router.vuejs.org/zh/guide/essentials/history-mode.html" target="_blank" rel="noopener noreferrer">https://router.vuejs.org/zh/guide/essentials/history-mode.html<ExternalLinkIcon/></a></p>
