<template><div><h2 id="_1、说说你对-spa-单页面的理解-它的优缺点分别是什么" tabindex="-1"><a class="header-anchor" href="#_1、说说你对-spa-单页面的理解-它的优缺点分别是什么" aria-hidden="true">#</a> 1、说说你对 SPA 单页面的理解，它的优缺点分别是什么？</h2>
<hr>
...
<h2 id="_2、v-show-与-v-if-有什么区别" tabindex="-1"><a class="header-anchor" href="#_2、v-show-与-v-if-有什么区别" aria-hidden="true">#</a> 2、v-show 与 v-if 有什么区别？</h2>
<hr>
<p><code v-pre>v-if</code>是真正的条件渲染，因为它会确保在切换过程中条件块内的事件监听器和子组件适当地被销毁和重建；也是惰性的：如果在初始渲染时条件为假，则什么也不做————知道条件第一次变为真时，才会开始渲染条件块。</p>
<p><code v-pre>v-show</code>就简单得多————不管初始条件是什么，元素都会被渲染，并且只是简单的基于 CSS 的&quot;display:none&quot;属性进行切换。</p>
<p>所以，<code v-pre>v-if</code>适用于在运行时很少改变条件，不需要频繁切换条件的场景；<code v-pre>v-show</code>则适用于需要非常频繁切换条件的场景。</p>
<h2 id="_3、class-与-style-如何动态绑定" tabindex="-1"><a class="header-anchor" href="#_3、class-与-style-如何动态绑定" aria-hidden="true">#</a> 3、Class 与 Style 如何动态绑定？</h2>
<hr>
<p>Class 可以通过对象语法和数组语法进行动态绑定:</p>
<ul>
<li>对象语法：</li>
</ul>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name"><span class="token namespace">v-bind:</span>class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>{ active: isActive, 'text-danger': hasError }<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>

data: { isActive: true, hasError: false }
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>数组语法：</li>
</ul>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name"><span class="token namespace">v-bind:</span>class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>[isActive ? activeClass : '', errorClass]<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>

data: { activeClass: 'active', errorClass: 'text-danger' }
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Style 也可以通过对象语法和数组语法进行动态绑定：</p>
<ul>
<li>对象语法：</li>
</ul>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name"><span class="token namespace">v-bind:</span>style</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>{ color: activeColor, fontSize: fontSize + 'px' }<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4、怎样理解-vue-的单向数据流" tabindex="-1"><a class="header-anchor" href="#_4、怎样理解-vue-的单向数据流" aria-hidden="true">#</a> 4、怎样理解 Vue 的单向数据流？</h2>
<hr>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>props: ['initialCounter'],
data: function () {
  return {
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>props: ['size'],
computed: {
...
<h2 id="_6、直接给一个数组赋值-vue-能监测到变化吗" tabindex="-1"><a class="header-anchor" href="#_6、直接给一个数组赋值-vue-能监测到变化吗" aria-hidden="true">#</a> 6、直接给一个数组赋值，Vue 能监测到变化吗？</h2>
<hr>
<p>由于 JavaScript 的限制，Vue 不能监测到以下数组的变动：</p>
<ul>
<li>当你利用索引直接设置一个数组项时，例如：<code v-pre>vm.items[indexOfItem]=newValue</code></li>
<li>当你修改数组长度时，例如：<code v-pre>vm.items.length = newLength</code></li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>为了解决第二个问题，Vue 提供了以下操作方法：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//Array.prototype.splice</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7、谈谈你对-vue-生命周期的理解" tabindex="-1"><a class="header-anchor" href="#_7、谈谈你对-vue-生命周期的理解" aria-hidden="true">#</a> 7、谈谈你对 Vue 生命周期的理解？</h2>
<hr>
<h3 id="_1-生命周期是什么" tabindex="-1"><a class="header-anchor" href="#_1-生命周期是什么" aria-hidden="true">#</a> (1)生命周期是什么？</h3>
<p>Vue 实例有一个完整的生命周期，也就是从开始创建、初始化数据、编译模板、挂载 DOM-&gt;渲染、更新-&gt;渲染、卸载等一些列过程，我们称这是 Vue 的生命周期。</p>
<h3 id="_2-各个生命周期的作用" tabindex="-1"><a class="header-anchor" href="#_2-各个生命周期的作用" aria-hidden="true">#</a> (2)各个生命周期的作用？</h3>
<table>
<thead>
<tr>
...
<h3 id="_3-生命周期示意图" tabindex="-1"><a class="header-anchor" href="#_3-生命周期示意图" aria-hidden="true">#</a> (3)生命周期示意图</h3>
<figure><img src="@source/category/Vue/images/Vue_life.jpg" alt="Vue生命周期示意图" tabindex="0" loading="lazy"><figcaption>Vue生命周期示意图</figcaption></figure>
<h2 id="_8、vue-的父组件和子组件生命周期钩子函数执行顺序" tabindex="-1"><a class="header-anchor" href="#_8、vue-的父组件和子组件生命周期钩子函数执行顺序" aria-hidden="true">#</a> 8、Vue 的父组件和子组件生命周期钩子函数执行顺序？</h2>
<hr>
...
<h2 id="_9、在哪个生命周期内调用异步请求" tabindex="-1"><a class="header-anchor" href="#_9、在哪个生命周期内调用异步请求" aria-hidden="true">#</a> 9、在哪个生命周期内调用异步请求？</h2>
<hr>
...
<h2 id="_10、在什么阶段才能访问操作-dom" tabindex="-1"><a class="header-anchor" href="#_10、在什么阶段才能访问操作-dom" aria-hidden="true">#</a> 10、在什么阶段才能访问操作 DOM？</h2>
<hr>
<p>在钩子函数 mounted 被调用前，Vue 已经将编译好的模板挂载到页面上，所以在 mounted 中可以访问操作 DOM。</p>
<h2 id="_11、父组件可以监听到子组件的生命周期吗" tabindex="-1"><a class="header-anchor" href="#_11、父组件可以监听到子组件的生命周期吗" aria-hidden="true">#</a> 11、父组件可以监听到子组件的生命周期吗？</h2>
<hr>
<p>比如有父组件 Parent 和子组件 Child，如果父组件监听到子组件挂载 mounted 就做一些逻辑处理，可以通过以下写法实现：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// Parent.vue</span>
...
<h2 id="_12、谈谈你对-keep-alive-的了解" tabindex="-1"><a class="header-anchor" href="#_12、谈谈你对-keep-alive-的了解" aria-hidden="true">#</a> 12、谈谈你对 keep-alive 的了解？</h2>
<hr>
...
<h2 id="_13、组件中-data-为什么是一个函数" tabindex="-1"><a class="header-anchor" href="#_13、组件中-data-为什么是一个函数" aria-hidden="true">#</a> 13、组件中 data 为什么是一个函数？</h2>
<hr>
<blockquote>
<p>为什么组件中的 data 必须是一个函数，然后 return 一个对象，而 new Vue 实例里，data 可以直接是一个对象？</p>
</blockquote>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// data</span>
...
<h2 id="_14、v-model-的原理" tabindex="-1"><a class="header-anchor" href="#_14、v-model-的原理" aria-hidden="true">#</a> 14、v-model 的原理？</h2>
<hr>
...
<p>以 input 表单元素为例：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>input v<span class="token operator">-</span>model<span class="token operator">=</span><span class="token string">'something'</span><span class="token operator">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果在自定义组件中，v-model 默认会利用名为 value 的 prop 和名为 input 的事件，如下所示：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>父组件：
...
<span class="token literal-property property">methods</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_15、vue-组件间通信有哪几种方式" tabindex="-1"><a class="header-anchor" href="#_15、vue-组件间通信有哪几种方式" aria-hidden="true">#</a> 15、Vue 组件间通信有哪几种方式？</h2>
<hr>
<p>Vue 组件间通信只要指以下 3 类通信：父子组件通信、隔代组件通信、兄弟组件通信，下面我们分别介绍每种通信方式且会说明此种方法可适用于哪类组件间通信。</p>
<h3 id="_1-props-emit-适用-父子组件通信" tabindex="-1"><a class="header-anchor" href="#_1-props-emit-适用-父子组件通信" aria-hidden="true">#</a> （1）<code v-pre>props</code> / <code v-pre>$emit</code> 适用 父子组件通信</h3>
<h3 id="_2-ref-与-parent-children-适用-父子组件通信" tabindex="-1"><a class="header-anchor" href="#_2-ref-与-parent-children-适用-父子组件通信" aria-hidden="true">#</a> （2）<code v-pre>ref</code> 与 <code v-pre>$parent</code> / <code v-pre>$children</code> 适用 父子组件通信</h3>
<ul>
<li><code v-pre>ref</code>：如果在普通的 DOM 元素上使用，引用指向的就是 DOM 元素；如果用在子组件上，引用就指向组件实例</li>
<li><code v-pre>$parent</code> / <code v-pre>$children</code>：访问父 / 子实例</li>
</ul>
<h3 id="_3-eventbus-emit-on-适用于-父子、隔代、兄弟组件通信" tabindex="-1"><a class="header-anchor" href="#_3-eventbus-emit-on-适用于-父子、隔代、兄弟组件通信" aria-hidden="true">#</a> （3）<code v-pre>EventBus</code> （<code v-pre>$emit</code> / <code v-pre>$on</code>） 适用于 父子、隔代、兄弟组件通信</h3>
<p>这种方法通过一个空的 Vue 实例作为中央事件总线（事件中心），用它来触发事件和监听事件，从而实现任何组件间的通信，包括父子、隔代、兄弟组件。</p>
<h3 id="_4-attrs-listeners-适用于-隔代组件通信" tabindex="-1"><a class="header-anchor" href="#_4-attrs-listeners-适用于-隔代组件通信" aria-hidden="true">#</a> （4）<code v-pre>$attrs</code>/<code v-pre>$listeners</code> 适用于 隔代组件通信</h3>
<ul>
<li><code v-pre>$attrs</code>：包含了父作用域中不被 prop 所识别 (且获取) 的特性绑定 ( class 和 style 除外 )。当一个组件没有声明任何 prop 时，这里会包含所有父作用域的绑定 ( class 和 style 除外 )，并且可以通过 v-bind=&quot;$attrs&quot; 传入内部组件。通常配合 inheritAttrs 选项一起使用。</li>
<li><code v-pre>$listeners</code>：包含了父作用域中的 (不含 .native 修饰器的) v-on 事件监听器。它可以通过 v-on=&quot;$listeners&quot; 传入内部组件</li>
</ul>
<h3 id="_5-provide-inject-适用于-隔代组件通信" tabindex="-1"><a class="header-anchor" href="#_5-provide-inject-适用于-隔代组件通信" aria-hidden="true">#</a> （5）<code v-pre>provide</code> / <code v-pre>inject</code> 适用于 隔代组件通信</h3>
...
<h3 id="_6-vuex-适用于-父子、隔代、兄弟组件通信" tabindex="-1"><a class="header-anchor" href="#_6-vuex-适用于-父子、隔代、兄弟组件通信" aria-hidden="true">#</a> （6）<code v-pre>Vuex</code> 适用于 父子、隔代、兄弟组件通信</h3>
...
<h2 id="_16、你使用过-vuex-吗" tabindex="-1"><a class="header-anchor" href="#_16、你使用过-vuex-吗" aria-hidden="true">#</a> 16、你使用过 Vuex 吗？</h2>
<hr>
<p>Vuex 是一个专为 Vue.js 应用程序开发的状态管理模式。每一个 Vuex 应用的核心就是 store（仓库）。“store” 基本上就是一个容器，它包含着你的应用中大部分的状态 ( state )。</p>
...
<h2 id="_17、使用过-vue-ssr-吗-说说-ssr" tabindex="-1"><a class="header-anchor" href="#_17、使用过-vue-ssr-吗-说说-ssr" aria-hidden="true">#</a> 17、使用过 Vue SSR 吗？说说 SSR？</h2>
<hr>
<blockquote>
...
<h2 id="_18、vue-router-路由模式有几种" tabindex="-1"><a class="header-anchor" href="#_18、vue-router-路由模式有几种" aria-hidden="true">#</a> 18、vue-router 路由模式有几种？</h2>
<hr>
<p>vue-router 有 3 种路由模式：hash、history、abstract，对应的源码如下所示：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">switch</span> <span class="token punctuation">(</span>mode<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h2 id="_19、能说下-vue-router-中常用的-hash-和-history-路由模式实现原理吗" tabindex="-1"><a class="header-anchor" href="#_19、能说下-vue-router-中常用的-hash-和-history-路由模式实现原理吗" aria-hidden="true">#</a> 19、能说下 vue-router 中常用的 hash 和 history 路由模式实现原理吗？</h2>
<hr>
<h3 id="_1-hash-模式的实现原理" tabindex="-1"><a class="header-anchor" href="#_1-hash-模式的实现原理" aria-hidden="true">#</a> （1）hash 模式的实现原理</h3>
<p>早期的前端路由的实现就是基于 location.hash 来实现的。其实现原理很简单，location.hash 的值就是 URL 中 # 后面的内容。比如下面这个网站，它的 location.hash 的值为 '#search'：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>https://www.word.com#search
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>hash 路由模式的实现主要是基于下面几个特性：</p>
<ul>
...
<h3 id="_2-history-模式的实现原理" tabindex="-1"><a class="header-anchor" href="#_2-history-模式的实现原理" aria-hidden="true">#</a> （2）history 模式的实现原理</h3>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>window.history.pushState(null, null, path);
window.history.replaceState(null, null, path);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>history 路由模式的实现主要基于存在下面几个特性：</p>
<ul>
...
<h2 id="_20、什么是-mvvm" tabindex="-1"><a class="header-anchor" href="#_20、什么是-mvvm" aria-hidden="true">#</a> 20、什么是 MVVM？</h2>
<hr>
...
<figure><img src="@source/category/Vue/images/MVVM.jpg" alt="什么是 MVVM?" tabindex="0" loading="lazy"><figcaption>什么是 MVVM?</figcaption></figure>
<h3 id="_1-view-层" tabindex="-1"><a class="header-anchor" href="#_1-view-层" aria-hidden="true">#</a> （1）View 层</h3>
<p>View 是视图层，也就是用户界面。前端主要由 HTML 和 CSS 来构建。</p>
<h3 id="_2-model-层" tabindex="-1"><a class="header-anchor" href="#_2-model-层" aria-hidden="true">#</a> （2）Model 层</h3>
<p>Model 是指数据模型，泛指后端进行的各种业务逻辑处理和数据操控，对于前端来说就是后端提供的 api 接口。</p>
<h3 id="_3-viewmodel-层" tabindex="-1"><a class="header-anchor" href="#_3-viewmodel-层" aria-hidden="true">#</a> （3）ViewModel 层</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>（2）ViewModel 层</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> app <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Vue</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  <span class="token literal-property property">el</span><span class="token operator">:</span> <span class="token string">"#app"</span><span class="token punctuation">,</span>
  <span class="token literal-property property">data</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token comment">// 用于描述视图状态</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
  <span class="token literal-property property">methods</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token comment">// 用于描述视图行为</span>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
  <span class="token property">"url"</span><span class="token operator">:</span> <span class="token string">"/your/server/data/api"</span><span class="token punctuation">,</span>
  <span class="token property">"res"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token property">"name"</span><span class="token operator">:</span> <span class="token string">"IoveC"</span><span class="token punctuation">,</span>
    <span class="token property">"domain"</span><span class="token operator">:</span> <span class="token string">"www.cnblogs.com"</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
<figure><img src="@source/category/Vue/images/two_way.jpg" alt="Vue 是如何实现数据双向绑定的？" tabindex="0" loading="lazy"><figcaption>Vue 是如何实现数据双向绑定的？</figcaption></figure>
<p>即：</p>
<ul>
...
<figure><img src="@source/category/Vue/images/Observer.png" alt="Vue 是如何实现数据双向绑定的？" tabindex="0" loading="lazy"><figcaption>Vue 是如何实现数据双向绑定的？</figcaption></figure>
<h3 id="_22、vue-框架怎么实现对象和数组的监听" tabindex="-1"><a class="header-anchor" href="#_22、vue-框架怎么实现对象和数组的监听" aria-hidden="true">#</a> 22、Vue 框架怎么实现对象和数组的监听？</h3>
<hr>
...
<h3 id="_23、proxy-与-object-defineproperty-优劣对比" tabindex="-1"><a class="header-anchor" href="#_23、proxy-与-object-defineproperty-优劣对比" aria-hidden="true">#</a> 23、Proxy 与 Object.defineProperty 优劣对比</h3>
<hr>
<p>Proxy 的优势如下:</p>
<ul>
...
<h2 id="_24、vue-怎么用-vm-set-解决对象新增属性不能响应的问题" tabindex="-1"><a class="header-anchor" href="#_24、vue-怎么用-vm-set-解决对象新增属性不能响应的问题" aria-hidden="true">#</a> 24、Vue 怎么用 vm.$set() 解决对象新增属性不能响应的问题 ？</h2>
<hr>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">set</span><span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">target</span><span class="token operator">:</span> Array<span class="token operator">&lt;</span>any<span class="token operator">></span> <span class="token operator">|</span> Object<span class="token punctuation">,</span> <span class="token literal-property property">key</span><span class="token operator">:</span> any<span class="token punctuation">,</span> <span class="token literal-property property">val</span><span class="token operator">:</span> any</span><span class="token punctuation">)</span><span class="token operator">:</span> any <span class="token punctuation">{</span>
...
<h2 id="_25、虚拟-dom-的优缺点" tabindex="-1"><a class="header-anchor" href="#_25、虚拟-dom-的优缺点" aria-hidden="true">#</a> 25、虚拟 DOM 的优缺点？</h2>
<hr>
<p>优点：</p>
<ul>
...
<h2 id="_26、虚拟-dom-实现原理" tabindex="-1"><a class="header-anchor" href="#_26、虚拟-dom-实现原理" aria-hidden="true">#</a> 26、虚拟 DOM 实现原理？</h2>
<hr>
...
<h2 id="_27、vue-中的-key-有什么作用" tabindex="-1"><a class="header-anchor" href="#_27、vue-中的-key-有什么作用" aria-hidden="true">#</a> 27、Vue 中的 key 有什么作用？</h2>
<hr>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">createKeyToOldIdx</span><span class="token punctuation">(</span><span class="token parameter">children<span class="token punctuation">,</span> beginIdx<span class="token punctuation">,</span> endIdx</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_28、你有对-vue-项目进行哪些优化" tabindex="-1"><a class="header-anchor" href="#_28、你有对-vue-项目进行哪些优化" aria-hidden="true">#</a> 28、你有对 Vue 项目进行哪些优化？</h2>
<hr>
<h3 id="_1-代码层面的优化" tabindex="-1"><a class="header-anchor" href="#_1-代码层面的优化" aria-hidden="true">#</a> （1）代码层面的优化</h3>
<ul>
...
<h3 id="_2-webpack-层面的优化" tabindex="-1"><a class="header-anchor" href="#_2-webpack-层面的优化" aria-hidden="true">#</a> （2）Webpack 层面的优化</h3>
<ul>
...
<h3 id="_3-基础的-web-技术的优化" tabindex="-1"><a class="header-anchor" href="#_3-基础的-web-技术的优化" aria-hidden="true">#</a> （3）基础的 Web 技术的优化</h3>
<ul>
<li>开启 gzip 压缩</li>
<li>浏览器缓存</li>
<li>CDN 的使用</li>
...
<h2 id="_29、对于即将到来的-vue3-0-特性你有什么了解的吗" tabindex="-1"><a class="header-anchor" href="#_29、对于即将到来的-vue3-0-特性你有什么了解的吗" aria-hidden="true">#</a> 29、对于即将到来的 vue3.0 特性你有什么了解的吗？</h2>
<hr>
<p>Vue 3.0 正走在发布的路上，Vue 3.0 的目标是让 Vue 核心变得更小、更快、更强大，因此 Vue 3.0 增加以下这些新特性：</p>
<h3 id="_1-监测机制的改变" tabindex="-1"><a class="header-anchor" href="#_1-监测机制的改变" aria-hidden="true">#</a> （1）监测机制的改变</h3>
...
<h3 id="_2-模板" tabindex="-1"><a class="header-anchor" href="#_2-模板" aria-hidden="true">#</a> （2）模板</h3>
...
<h3 id="_3-对象式的组件声明方式" tabindex="-1"><a class="header-anchor" href="#_3-对象式的组件声明方式" aria-hidden="true">#</a> （3）对象式的组件声明方式</h3>
...
<h3 id="_4-其它方面的更改" tabindex="-1"><a class="header-anchor" href="#_4-其它方面的更改" aria-hidden="true">#</a> （4）其它方面的更改</h3>
...
<h2 id="_30、手写-promise-all-和-promise-race" tabindex="-1"><a class="header-anchor" href="#_30、手写-promise-all-和-promise-race" aria-hidden="true">#</a> 30、手写 Promise.all 和 Promise.race</h2>
<hr>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>Promise<span class="token punctuation">.</span><span class="token function-variable function">all</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">iterater</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">let</span> count <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span>
  <span class="token keyword">let</span> len <span class="token operator">=</span> iterater<span class="token punctuation">.</span>length<span class="token punctuation">;</span>
  <span class="token keyword">let</span> res <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
  <span class="token keyword">return</span> <span class="token keyword">new</span> <span class="token class-name">Promise</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">resolve<span class="token punctuation">,</span> reject</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
    <span class="token keyword">for</span> <span class="token punctuation">(</span>item <span class="token keyword">of</span> iterater<span class="token punctuation">)</span> <span class="token punctuation">{</span>
      Promise<span class="token punctuation">.</span><span class="token function">resolve</span><span class="token punctuation">(</span>iterater<span class="token punctuation">[</span>item<span class="token punctuation">]</span><span class="token punctuation">)</span>
        <span class="token punctuation">.</span><span class="token function">then</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">data</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
          res<span class="token punctuation">[</span>item<span class="token punctuation">]</span> <span class="token operator">=</span> data<span class="token punctuation">;</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="promise-race" tabindex="-1"><a class="header-anchor" href="#promise-race" aria-hidden="true">#</a> Promise.race()</h3>
<p><b>核心思路：</b>
谁先决议那么就返回谁，所以将 all 的计数器和逻辑判断全部去除掉就可以了。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>romise<span class="token punctuation">.</span><span class="token function-variable function">race</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">iterater</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">return</span> <span class="token keyword">new</span> <span class="token class-name">Promise</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">resolve<span class="token punctuation">,</span> reject</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
    <span class="token keyword">for</span> <span class="token punctuation">(</span>item <span class="token keyword">of</span> iterater<span class="token punctuation">)</span> <span class="token punctuation">{</span>
      Promise<span class="token punctuation">.</span><span class="token function">resolve</span><span class="token punctuation">(</span>iterater<span class="token punctuation">[</span>item<span class="token punctuation">]</span><span class="token punctuation">)</span>
        <span class="token punctuation">.</span><span class="token function">then</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">data</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">const</span> promise3 <span class="token operator">=</span> <span class="token number">42</span><span class="token punctuation">;</span>
Promise<span class="token punctuation">.</span><span class="token function">race</span><span class="token punctuation">(</span><span class="token punctuation">[</span>promise1<span class="token punctuation">,</span> promise2<span class="token punctuation">,</span> promise3<span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">then</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">values</span><span class="token punctuation">)</span> <span class="token operator">=></span>
  console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>values<span class="token punctuation">)</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>
