<template><div><figure><img src="@source/category/其他/images/status.png" alt="HTTP 常见的状态码" tabindex="0" loading="lazy"><figcaption>HTTP 常见的状态码</figcaption></figure>
...
<p>它由 RFC2616 规范定义的，并得到<code v-pre>RFC 2518</code>、<code v-pre>RFC 2817</code>、<code v-pre>RFC 2295</code>、<code v-pre>RFC 2774</code>与 <code v-pre>RFC 4918</code>等规范扩展</p>
