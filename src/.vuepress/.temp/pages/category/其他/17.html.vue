<template><div><figure><img src="@source/category/其他/images/tcp-three-four.png" alt="TCP三次握手和四次挥手" tabindex="0" loading="lazy"><figcaption>TCP三次握手和四次挥手</figcaption></figure>
<h2 id="一、三次握手" tabindex="-1"><a class="header-anchor" href="#一、三次握手" aria-hidden="true">#</a> 一、三次握手</h2>
<hr>
...
<figure><img src="@source/category/其他/images/tcp-three.png" alt="TCP三次握手" tabindex="0" loading="lazy"><figcaption>TCP三次握手</figcaption></figure>
<p>上述每一次握手的作用如下：</p>
<ul>
<li>
...
<h3 id="为什么不是两次握手" tabindex="-1"><a class="header-anchor" href="#为什么不是两次握手" aria-hidden="true">#</a> 为什么不是两次握手?</h3>
...
<h2 id="二、四次挥手" tabindex="-1"><a class="header-anchor" href="#二、四次挥手" aria-hidden="true">#</a> 二、四次挥手</h2>
<hr>
<p><code v-pre>tcp</code>终止一个连接，需要经过四次挥手</p>
<p>过程如下：</p>
<ul>
...
<figure><img src="@source/category/其他/images/tcp-four.png" alt="TCP四次挥手" tabindex="0" loading="lazy"><figcaption>TCP四次挥手</figcaption></figure>
<p>四次挥手原因</p>
...
<figure><img src="@source/category/其他/images/tcp-complete.png" alt="TCP三次握手和四次挥手" tabindex="0" loading="lazy"><figcaption>TCP三次握手和四次挥手</figcaption></figure>
</div></template>
