<template><div><h2 id="一、ajax-是什么" tabindex="-1"><a class="header-anchor" href="#一、ajax-是什么" aria-hidden="true">#</a> 一、Ajax 是什么？</h2>
<hr>
...
<p><code v-pre>Ajax</code>的原理简单来说通过<code v-pre>XmlHttpRequest</code>对象来向服务器发异步请求，从服务器获得数据，然后用 JavaScript 来操作 DOM 而更新页面</p>
<p>流程图如下：</p>
<figure><img src="@source/category/其他/images/xmlHttpRequest.png" alt="new XmlHttpRequest" tabindex="0" loading="lazy"><figcaption>new XmlHttpRequest</figcaption></figure>
<p>下面举个例子：</p>
<p>领导想找小李汇报一下工作，就委托秘书去叫小李，自己就接着做其他事情，直到秘书告诉他小李已经到了，最后小李跟领导汇报工作</p>
<p>浏览器可以发送<code v-pre>HTTP</code>请求后，接着做其他事情，等收到 XHR 返回来的数据再进行操作</p>
...
<ul>
<li><code v-pre>method</code>：表示当前的请求方式，常见的有<code v-pre>GET</code>、<code v-pre>POST</code></li>
<li><code v-pre>url</code>：服务端地址</li>
<li><code v-pre>async</code>：布尔值，表示是否异步执行操作，默认为<code v-pre>true</code></li>
<li><code v-pre>user</code>: 可选的用户名用于认证用途；默认为<code v-pre>null</code></li>
<li><code v-pre>password</code>: 可选的密码用于认证用途，默认为<code v-pre>null</code></li>
</ul>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>xhr<span class="token punctuation">.</span><span class="token function">send</span><span class="token punctuation">(</span><span class="token punctuation">[</span>body<span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>body</code>: 在 XHR 请求中要发送的数据体，如果不传递数据则为 <code v-pre>null</code></p>
...
<h3 id="绑定onreadystatechange事件" tabindex="-1"><a class="header-anchor" href="#绑定onreadystatechange事件" aria-hidden="true">#</a> 绑定<code v-pre>onreadystatechange</code>事件</h3>
<p><code v-pre>onreadystatechange</code> 事件用于监听服务器端的通信状态，主要监听的属性为<code v-pre>XMLHttpRequest.readyState</code>,关于<code v-pre>XMLHttpRequest.readyState</code>属性有五个状态，如下图显示</p>
<figure><img src="@source/category/其他/images/readyState.png" alt="XMLHttpRequest.readyState" tabindex="0" loading="lazy"><figcaption>XMLHttpRequest.readyState</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、封装" tabindex="-1"><a class="header-anchor" href="#三、封装" aria-hidden="true">#</a> 三、封装</h2>
