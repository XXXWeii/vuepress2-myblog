...
<p>作者：JetTsang</p>
<p><a href="https://juejin.cn/post/7219961144584552504" target="_blank" rel="noopener noreferrer">https://juejin.cn/post/7219961144584552504<ExternalLinkIcon/></a></p>
</blockquote>
...
<h2 id="引出" tabindex="-1"><a class="header-anchor" href="#引出" aria-hidden="true">#</a> 引出</h2>
<hr>
<p>题目：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 设计一个函数，可以限制请求的并发，同时请求结束之后，调用callback函数</span>
...
<li>
<p>定义常数和函数</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">sendRequest</span><span class="token punctuation">(</span><span class="token parameter">requestList<span class="token punctuation">,</span> limits<span class="token punctuation">,</span> callback</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h2 id="另一种实现" tabindex="-1"><a class="header-anchor" href="#另一种实现" aria-hidden="true">#</a> 另一种实现</h2>
<hr>
<p>核心代码是判断是当你 【有任务执行完成】 ，再去判断是否有剩余还有任务可执行。可以先维护一个 pool（代表当前执行的任务），利用 await Promise.race 这个 pool，不就知道是否有任务执行完毕了吗？</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">async</span> <span class="token keyword">function</span> <span class="token function">sendRequest</span><span class="token punctuation">(</span><span class="token parameter">requestList<span class="token punctuation">,</span> limits<span class="token punctuation">,</span> callback</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h3 id="疑问" tabindex="-1"><a class="header-anchor" href="#疑问" aria-hidden="true">#</a> 疑问</h3>
<ol>
<li>Promise.allSettled 和 race 传入的<code v-pre>Promise&lt;any&gt;[]</code>可以被其中的触发微任务操作增减，这样做会改变结果吗？</li>
</ol>
<h2 id="有什么能拓展的功能呢" tabindex="-1"><a class="header-anchor" href="#有什么能拓展的功能呢" aria-hidden="true">#</a> 有什么能拓展的功能呢？</h2>
<hr>
