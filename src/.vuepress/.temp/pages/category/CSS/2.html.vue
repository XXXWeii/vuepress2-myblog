<template><div><h2 id="成品效果" tabindex="-1"><a class="header-anchor" href="#成品效果" aria-hidden="true">#</a> 成品效果</h2>
<hr>
<p>今天分享一个用 css3 来实现一个最近特别流行的故障风格的文字展示动画，我敢说，只要你在你的项目中用到这个动画，面试官看到了一定会眼前一亮。下面先来看一下成品图：</p>
<figure><img src="@source/category/CSS/images/1.gif" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>该动画效果就比较复杂了，用到的知识比较多，例如 <strong>「css 伪元素 、元素自定义属性 、蒙版属性 、animation 动画等等」</strong></p>
<h2 id="标签元素部分" tabindex="-1"><a class="header-anchor" href="#标签元素部分" aria-hidden="true">#</a> 标签元素部分</h2>
<hr>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里我们使用了自定义属性，即 <strong>「data-」</strong> 加上我们自定义的属性名，我们将我们的文字内容作为该属性的值，方便之后伪元素获取到对应的文字</p>
<h2 id="keyframes-部分" tabindex="-1"><a class="header-anchor" href="#keyframes-部分" aria-hidden="true">#</a> @keyframes 部分</h2>
<hr>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token atrule"><span class="token rule">@keyframes</span> animation-before</span> <span class="token punctuation">{</span>
...
<figure><img src="@source/category/CSS/images/2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="@source/category/CSS/images/3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>图中蓝色边框的部分不是蒙版的作用区域，因此我们无法看到该区域的内容，真实情况如下图所示</p>
<figure><img src="@source/category/CSS/images/4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>在了解了蒙版的使用情况了以后，我们就通过 @keyframes 来设置逐帧动画，使蒙版的作用区域在垂直方向一直变化，实现上下抖动的效果，代码就如上所述</p>
<h2 id="具体样式" tabindex="-1"><a class="header-anchor" href="#具体样式" aria-hidden="true">#</a> <strong>具体样式</strong></h2>
<hr>
